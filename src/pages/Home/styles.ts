...
form{ //estilização em cascata. Consigo estilizar o form que está dentro do mais
display: flex;
flex-direction: column;
align-items: center;
gap: 3.5rem
...
font-family: 'Roboto Mono';//se ele não encontrar essa fonte, eu quero que ele encontre qualquer outra fonte monoespaçada
font-size: 10rem;
line-height: 8rem;
color: ${(props) => props.theme['gray-100']};
...
&:disabled { //se o botão estiver desabilitado
opacity: 0.7;
cursor: not-allowed;
}
